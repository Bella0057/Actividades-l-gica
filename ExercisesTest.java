...
public class ExercisesTest {
    ...
    void testExercise4() {
        ...
        String resultadoReal = "El área de la figura es: " + Double.toString(ejercicios.ejercicio4(tipoFigura, ladoCuadrado, baseTriangulo, alturaTriangulo,
                radioCirculo));
        assertEquals(resultadoEsperado, resultadoFinal(resultadoReal));
        tipoFigura = 2;
        ladoCuadrado = 0.0;
        baseTriangulo = 4.0;
        alturaTriangulo = 3.0;
        ...
        resultadoReal = "El área de la figura es: " + Double.toString(ejercicios.ejercicio4(tipoFigura, ladoCuadrado, baseTriangulo, alturaTriangulo, radioCirculo));
        assertEquals(resultadoEsperado, resultadoFinal(resultadoReal));
        tipoFigura = 3;
        ladoCuadrado = 0.0;
        baseTriangulo = 0.0;
    ...
    public String resultadoFinal(String result){
        if(result != "El área de la figura es: -1"){
            return result;
        }else{
